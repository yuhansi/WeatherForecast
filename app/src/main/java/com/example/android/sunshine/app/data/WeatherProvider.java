...
public class WeatherProvider extends ContentProvider {
    ...
    /*
     * Here is where to create the UriMatcher
    ...
    static UriMatcher buildUriMatcher() {
        ...
        // Use the constants from WeatherContract to help define the types to the UriMatcher
    ...
    /*
     * Here is the code for the getType function that uses the UriMatcher
     */
    @Override
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        // Use the uriMatcher to match the WEATHER and LOCATION URI's needed to be handled
        ...
        // Notify the uri listeners (using the content resolver)
    ...
    public int update(
        ...
        // Use the uriMatcher to match the WEATHER and LOCATION URI's needed to be handled
        // If it doesn't match these, throw an UnsupportedOperationExceptiom
        final int match = sUriMatcher.match(uri);
