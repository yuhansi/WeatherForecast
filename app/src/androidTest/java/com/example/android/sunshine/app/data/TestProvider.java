...
public class TestProvider extends AndroidTestCase {
    ...
    public void testBasicWeatherQuery() {
        ...
        // Use the location ID returned to insert weather values
        ...
        // Make sure the correct cursor is obtained out of the database
    ...
    public void testBasicLocationQueries() {
        ...
        // Check if the NotificationUri has been set correctly
        // This test is only supported against API level 19 or higher
    ...
    public void testInsertReadProvider() {
        ...
        // This time, register directly with the content resolver
        TestUtilities.TestContentObserver tco = TestUtilities.getTestContentObserver();
        mContext.getContentResolver().registerContentObserver(LocationEntry.CONTENT_URI, true, tco);
        Uri locationUri = mContext.getContentResolver().insert(LocationEntry.CONTENT_URI, testValues);

        // Check to see if the content observer did get called
        // If this fails, then the insert location isn't calling
        ...
        // Add weather values to the location ID returned
        ContentValues weatherValues = TestUtilities.createWeatherValues(locationRowId);
        ...
        // Check to see if the content observer did get called
        // If this fails, then the insert weather in the ContentProvider isn't calling
        // getContext().getContentResolver().notifyChange(uri, null);
        tco.waitForNotificationOrFail();
        mContext.getContentResolver().unregisterContentObserver(tco);
        ...
        // Add the location values in with the weather data so to verify that the join worked
        // and all the values were obtained
